<div id="header" class="clearfix lazy" data-bg="url(thumb/1366x110/1/<?=_upload_hinhanh_l.$banner_qc['photo_'.$lang]?>)">
  <div id="banner">
    <div class="inner">
      <?php if(!$_GET['id']){ ?><h1><?=$title_bar?></h1><?php } ?>
      <div class="logo">
        <a href=""><img src="thumb/279x137/1/<?=_upload_hinhanh_l.$logo['photo_'.$lang]?>" alt="<?=$row_setting['ten_'.$lang]?>" class="mw100"/></a>
      </div>
      <div class="company"><img src="thumb/668x143/1/<?=_upload_hinhanh_l.$banner['photo_'.$lang]?>" alt="<?=$row_setting['ten_'.$lang]?>" class="mw100"/></div>
