<?php  if(!defined('_source')) die("Error");
		...
		if($id!=''){ 
			...
			$d->reset();
			$sql_other = "select id,ten_$lang,giaban,giacu,tenkhongdau,photo,banchay from #_product where type='".$type_bar."' and id!='".$row_detail['id']."'";
			...
			$sql="select id,ten_$lang,giaban,giacu,tenkhongdau,photo,banchay from";
