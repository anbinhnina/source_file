...
<div class="control_frm" style="margin-top:25px;">
    <div class="bc">
        <ul id="breadcrumbs" class="breadcrumbs">
        	<li><a href="index.php?com=product&act=add_properties<?php if($_REQUEST['type']!='') echo'&type='. $_REQUEST['type'];?>"><span>Thêm màu sản phẩm</span></a></li>
...
<form name="supplier" id="validate" class="form" action="index.php?com=product&act=save_properties<?php if($_REQUEST['type']!='') echo'&type='. $_REQUEST['type'];?>&id_product=<?=$_GET['id_product']?>" method="post" enctype="multipart/form-data">
	...
	<div class="widget">
		<div class="formRow">
			<div class="formRight">
            	...
            	<a href="index.php?com=product&act=man_properties<?php if($_REQUEST['type']!='') echo'&type='. $_REQUEST['type'];?>" onClick="if(!confirm('Bạn có muốn thoát không ? ')) return false;" title="" class="button tipS" original-title="Thoát">Thoát</a>
