    ...
    <tbody>
       ...
       <td>
        ...
        <td align="center">
          ...
          <a data-val2="table_<?=$_GET['com']?>" rel="<?=$items[$i]['active']?>" data-val3="active" title class="status smallButton tipS" original-title="<?php if($items[$i]['active']==0) echo 'Click để hiện'; else echo "Click để ẩn"; ?>" data-val0="<?=$items[$i]['id']?>" >
            <?php if($items[$i]['active']==1) { ?>
